...
8. Implement and verify publisher key continuity (plan 01) — in progress.
9. Implement and verify installed-version launch (plan 02) — pending.
10. Continue remaining plans in dependency order — pending.
